...
step "Upgrade paket Termux"     pkg upgrade -y
...
# 🧹 Matikan proses termux-x11 lama kalau masih nyangkut (dieksekusi
#    tiap kali skrip ini jalan, bukan cuma sekali saat install)
